	...
	<div id="container" class="setting_wrap">
		...
		<div class="container">
			...
			<section class="content_area">
				...
				<form action="${root }user/group" method="post" class="set_form">
						...
						<li class="set_file1 box">
							...
							<div>
								...
								<ul class="comm_buttons_s">
									<li>
										<input type="file" id="grphoto" name="grphoto" accept="image/*">
					...
					<ul class="comm_buttons">
						<li><button type="submit" class="comm_btn sbm">그룹 생성</button></li>
					</ul>
				</form>
			</section>
			<!-- } 컨텐츠영역 끝 -->
