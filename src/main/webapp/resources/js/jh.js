...
function feedList(data,view,pronum,prophoto,logincheck){
	if(view=='search'){
		...
		$(data[0]).each(function(index){
			...
			if(data[0][index].profile.prophoto.isEmpty==null||data[0][index].profile.prophoto.isEmpty==''||data[0][index].profile.prophoto.isEmpty==undefined||data[0][index].profile.prophoto.isEmpty){
